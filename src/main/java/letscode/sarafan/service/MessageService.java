...
import letscode.sarafan.dto.EvenType;
...
public class MessageService {
    ...
    private final BiConsumer<EvenType, Message> wsSender;
    ...
    public void delete(Message message) {
        ...
        wsSender.accept(EvenType.REMOVE, message);
    }
    ...
    public Message update(Message messageFromDb, Message message) throws IOException {
        ...
        wsSender.accept(EvenType.UPDATE, updatedMessage);
    ...
    public Message create(Message message, User user) throws IOException {
        ...
        wsSender.accept(EvenType.CREATE, updatedMessage);
